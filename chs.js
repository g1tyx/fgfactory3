...
var cnItems = {
    ...
    "Data corrupted!": "数据损坏!",
    "Download": "下载",
    "Dyson Sphere Program": "戴森球程序",
    "Employee of the Planet": "地球雇员",
    "Freepik": "Freepik",
    "Got it!": "得到它!",
    "Handcrafting": "手工制作",
    "Icons provided by": "提供的图标",
    "Iron Ore": "铁矿石",
    "Iron Rod": "铁棒",
    "Let's go!": "我们走吧!",
    "Local data": "本地数据",
    "Local data copied in clipboard!": "在剪贴板中复制本地数据！",
    "Make a donation": "捐款",
